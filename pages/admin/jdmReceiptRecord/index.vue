...
import {
  ...
  getDefulatReceiptRecordCriteria,
} from '~/models'
...
const criteria = reactive(getDefulatReceiptRecordCriteria())
...
async function search() {
  ...
  if(checkQuery())
  {
    criteria.printMonth = formatDate(criteria.printMonth)
    PrintReceiptRecord()
  }
}
...
async function PrintReceiptRecord() {
  try {
                ...
                <el-row :gutter="20">
                  <el-col :lg="12" :xl="12" :xs="24" :sm="24">
                    <el-form-item label="列印年月">
                      <div class="block">
                        <el-date-picker v-model="criteria.printMonth" type="month" placeholder="" size="default" />
                      </div>
                    </el-form-item>
                  </el-col>
                </el-row>
