      ...
      <el-col :span="24">
        ...
        <el-card header="查詢結果" class="mt-4">
          ...
          <el-table :data="queryResult.items" stripe style="width: 100%">
            ...
            <el-table-column prop="placeOrderker" label="委託者功能" align="center">
              <template #default="{ row }">
                <ClientOnly v-for="(placeOrderker) in row.placeOrderker" :key="placeOrderker">
                  <el-col :span="24">
                    <a v-if="placeOrderker === '0'">看不到此筆</a>
                    <el-button
                      v-if="placeOrderker === '1'" type="primary"
                      @click="navigateTo({ path: '/admin/entrustOrderApplication/Edit' })"
                    >
                      <AdminIcon name="i-carbon:edit" class="pr-1" />
                      編輯
                    </el-button>
                    <el-button v-if="placeOrderker === '2'" type="danger">
                      <AdminIcon name="i-carbon:delete" class="pr-1" />
                      刪除
                    </el-button>
                    <el-button v-if="placeOrderker === '3'" type="warning">
                      <AdminIcon name="i-carbon:arrow-right" class="pr-1" />
                      開始呈核
                    </el-button>
                    <el-button v-if="placeOrderker === '4'" type="warning">
                      <AdminIcon name="i-carbon:airline-rapid-board" class="pr-1" />
                      呈核
                    </el-button>
                    <el-button
                      v-if="placeOrderker === '5'" type="success"
                      @click="navigateTo({ path: '/admin/entrustOrderApplication/Edit' })"
                    >
                    ...
                    <el-button
                      v-if="placeOrderker === '6'" type="primary"
                      @click="navigateTo({ path: '/admin/entrustOrderApplication/Edit' })"
                    >
                      <AdminIcon name="i-carbon:connection-receive" class="pr-1" />
                      領取報告
                    </el-button>
                    <el-button v-if="placeOrderker === '7'" type="warning">
